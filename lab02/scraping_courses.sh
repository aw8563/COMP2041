...
echo $undergraduate | sed "s/<TD class=\"\">/\n/g" | sed "s/<TD class=\"\" align=\"left\">/\n/g" | egrep "( |>|/)$1" | egrep -o "/[^/]*\.html\">.*</A>" | cut -d ">" -f1,2 | sed "s/[/>]//g" | sed "s/<A//g" | sed "s/\.html\"/ /g" | grep -v "glossary"
echo $postgraduate | sed "s/<TD class=\"\">/\n/g" | sed "s/<TD class=\"\" align=\"left\">/\n/g" | egrep "( |>|/)$1" | egrep -o "/[^/]*\.html\">.*</A>" | cut -d ">" -f1,2 | sed "s/[/>]//g" | sed "s/<A//g" | sed "s/\.html\"/ /g" | grep -v "glossary"

# cat out | egrep "( |>|/)OPTM" | egrep -o "/[^/]*\.html\">.*</A>" | cut -d ">" -f1,2 | sed "s/[/>]//g" | sed "s/<A//g" | sed "s/\.html\"/ /g"
